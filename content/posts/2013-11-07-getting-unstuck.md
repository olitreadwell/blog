...
Throughout life you are plagued with an [interminable to-do list](http://olitreadwell.github.io/posts/the-backwards-bucket-list). Stuck on that list is a to-do item sitting, waiting to be ticked off.

The to-do is going to take you awhile. It might be twohours, might be twoweeks, but you've got some reason it can't be done right now. So it gets put off. As you delay, the inertia of the to-do is growing. Each time you glance at it, it glows bright red. It glares at you; you avoid its stare.
...
<figure>
    <a href="http://a3.files.readwrite.com/image/upload/c_fit,q_80,w_630/MTIyMzAzMTgwMDIwMTU0OTgy.jpg"><img src="http://a3.files.readwrite.com/image/upload/c_fit,q_80,w_630/MTIyMzAzMTgwMDIwMTU0OTgy.jpg"></a>
    <figcaption><a href="http://readwrite.com/2013/03/19/fake-grimlock-win-like-stupid" title="VINN DIAGRAM OF REAL LIFE">VINN DIAGRAM OF REAL LIFE</a>.</figcaption>
</figure>
...
Recently, there's been an emphasis on Grit. To keep at it like a bull mule. Slowly grind it out, that's success.

When I am stuck, I wonder what would happen if I did the same thing differently.

So I tend to restart.

The goal remains the same, but the perspective is different. When you're heading in the right direction, changing the your attack plan, will get you to your destination.

Getting stuck is debilitating. You realise you don't know how to get moving again. Most of us are stuck because of our perspective on the problem.
...
Hopefully in reading this you can help get yourself unstuck.
